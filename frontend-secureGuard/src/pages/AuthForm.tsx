    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-8 md:w-1/2 flex flex-col justify-center items-center">
          ...
          >
            <Icon name="FaShieldAlt" library="fa" className="text-5xl text-teal-300 mx-auto mb-4" />
            ...
            >
              {!isLogin && (
                <div className="relative">
                  <Icon name="FaUser" library="fa" className="text-lg absolute left-3 top-1/2 transform -translate-y-1/2 text-teal-200" />
                  <input
                    type="text"
              ...
              <div className="relative">
                <Icon name="FaEnvelope" library="fa" className="text-lg absolute left-3 top-1/2 transform -translate-y-1/2 text-teal-200" />
                <input
                  type="email"
              ...
              <div className="relative">
                <Icon name="FaLock" library="fa" className="text-lg absolute left-3 top-1/2 transform -translate-y-1/2 text-teal-200" />
                <input
        ...
        <div className="relative md:w-1/2 overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-8">
            <h3 className="text-3xl font-bold mb-4 text-center">Seguridad de Vanguardia</h3>
            <p className="text-lg text-center mb-6">
              SecureGuard emplea encriptación de última generación y medidas de seguridad avanzadas para proteger tus activos digitales.
            </p>
            <div className="grid grid-cols-2 gap-4 w-full max-w-md">
              ...
              >
                <Icon name="FaLock" library="fa" className="text-teal-300 mb-2 text-3xl" />
                <span className="text-sm text-center">Encriptación de extremo a extremo</span>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4 flex flex-col items-center"
              >
                <Icon name="FaFingerprint" library="fa" className="text-teal-300 mb-2 text-3xl" />
                <span className="text-sm text-center">Autenticación biométrica</span>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4 flex flex-col items-center"
              >
                <Icon name="FaShieldAlt" library="fa" className="text-teal-300 mb-2 text-3xl" />
              ...
              <motion.div
                ...
                className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4 flex flex-col items-center"
              >
                <Icon name="FaKey" library="fa" className="text-teal-300 mb-2 text-3xl" />
                <span className="text-sm text-center">Autenticación de múltiples factores</span>
              </motion.div>
            </div>
          </div>
        </div>
