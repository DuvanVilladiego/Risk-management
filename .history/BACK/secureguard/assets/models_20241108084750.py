...
class Assets(models.Model):
    ...
    description = models.TextField(default=0, blank=False, db_column='description_assets')
    ...
    price = models.DecimalField(max_digits=8, decimal_places=2, null=False, db_column='assetcost')
